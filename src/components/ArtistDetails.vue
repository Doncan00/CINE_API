...
onMounted(async () => {
    ...
    // ifno actor
    fetch(`https://api.themoviedb.org/3/person/${artist_id.value}`, requestOptions)
    ...
    // conocido por info
    fetch(`https://api.themoviedb.org/3/person/${artist_id.value}/combined_credits?`, requestOptions)
        .then(response => response.json())
        .then(result => {
